#German Tax Benefit Calculator Static 2015
...
def postgov_by_hours(pid, hours_1, hours_2):
    ...
    if labor_income_1 != labor_income_1:
        labor_income_1 = 0 #!
    age= MASEdata_2015["age"][i]
    #worktime_weekly= MASEdata_2015["worktime_weekly"][i]
    Alg2= MASEdata_2015["ALG2"][i]
    partner= MASEdata_2015["partner"][i]
    gender= MASEdata_2015["gender"][i]
    ...
    wage_1=MASEdata_2015["wages"][i]/4
    if wage_1 != wage_1:
        wage_1 = 0
    ...
    if partner==1:
        ...
        if len(partner_index) != 0:
            ...
            if labor_income_2 != labor_income_2:
                labor_income_2 = 0  
            wage_2=MASEdata_2015["wages"][partner_index]/4
            if wage_2 != wage_2:
                wage_2 = 0
...
results2015= []
results2015.append(["syear","pid","partner","hid","dpi"])
...
for i in range(MASEdata_2015.shape[0]):
    ...
    post_tax_income *= months #!
    post_government_hh= post_tax_income+ALG2_hh+sa_hh+hb_hh+asset_income+private_transfers
    results2015.append([syear, pid, partner, hid, post_government_hh])


pdresults= pd.DataFrame(results2015)
pdresults.to_csv("results2015static.csv")
