#German Tax Benefit Calculator clogit 2020
...
def postgov_by_hours(pid, hours_1, hours_2):
    ...
    wage_1=MASEdata_2020["lostwages"][i]/4
    if wage_1 != wage_1:
        wage_1 = 0
    ...
    syear=MASEdata_2020["syear"][i]
    education_1=MASEdata_2020["education"] #şimoş yeni burası
    rhours_1 = MASEdata_2020["hours"][i] #bu line yeni şimoş
    ...
    if partner==1:
        ...
        if len(partner_index) != 0:
            ...
            if labor_income_2 != labor_income_2:
                labor_income_2 = 0  
            wage_2=MASEdata_2020["lostwages"][partner_index]/4
            if wage_2 != wage_2:
                wage_2 = 0
            ...
            education_2= MASEdata_2020["education"][partner_index] #bu line yeni şimoş
            age_2= MASEdata_2020["age"][partner_index] #bu line yeni şimoş
            
            rhours_2 = MASEdata_2020["hours"][partner_index] #bu line yeni şimoş
            gender_2 = MASEdata_2020["gender"][partner_index] #bu line yeni şimoş
            if "1" in gender_2:
                gender_2=1
            elif "2" in gender_2:
                    gender_2=2
...
results2020= []
results2020.append(["partner","syear","hid","pid1","wage1","hours1","chosen_hours1","leisure1","pid2","wage2","hours2","chosen_hours2","leisure2","dpi","gross","choice","getALG1","getother","education_1","education_2","age_1","age_2","state","n_child_0_1", "n_child_2_4","n_child_5_7","n_child_8_10","n_child_11_12","n_child_13_15","n_child_16_18","marital_status","disabled_1","disabled_2"]) #!!!!!!!!!!!!!
...
for i in range(MASEdata_2020.shape[0]):
    ...
    if pid in seen:
        ...
        gender_1= MASEdata_2020["gender"][i] #bu line yeni şimoş
        partner= MASEdata_2020["partner"][i]
        if partner>=1 and partner<=4:
            partner=1
        else:
    ...
    work_experience=MASEdata_2020["work_experience"][i]
    hid=MASEdata_2020["hid"][i]
    education_1= MASEdata_2020["education"][i] #bu line yeni şimoş
    disabled_1= MASEdata_2020["disabled_1"][i]
    ...
    if partner == 1:
        ...
        for job1 in [0,10,20,30,40,50,60]:
            for job2 in [0,10,20,30,40,50,60]:
                ...
                #results2020.append([hid,pid,wage_1, job1, 80- job1, partner_number, wage_2, job2, 80-job2,post_government_hh, choice])
                post_gov_calc, gets_ALG1, gets_other = postgov_by_hours(pid, job1, job2) #!!!!!!!!!!!!!
                results2020.append([partner,syear,hid,pid,wage_1, job1, chosen_hours1, 80- job1, partner_number, wage_2, job2, chosen_hours2, 80-job2,post_gov_calc,(wage_1 * job1+wage_2*job2)*weeks+asset_income+private_transfers, choice, gets_ALG1, gets_other, education_1, education_2,age_1, age_2, state, n_child_0_1, n_child_2_4,n_child_5_7,n_child_8_10,n_child_11_12,n_child_13_15,n_child_16_18,marital_status,disabled_1,disabled_2]) #results appended bu line yeni şimoş
    else:
        chosen_hours1 = min(job_choices, key=lambda x:abs(x-hours_1))
        for job1 in [0,10,20,30,40,50,60]:
            ...
            results2020.append([partner,syear,hid,pid,wage_1, job1, chosen_hours1, 80- job1, 0, 0, 0, 0, 0, post_gov_calc, (wage_1 * job1)*weeks+asset_income+private_transfers,choice, gets_ALG1, gets_other, education_1, "",age_1, "", state, n_child_0_1, n_child_2_4,n_child_5_7,n_child_8_10,n_child_11_12,n_child_13_15,n_child_16_18,marital_status,disabled_1,""])#!!!!!!!!!!!!! results appended bu line yeni şimoş
    


#results2020.append(["partner","hid","pid1","wage1","hours1","leisure1","pid2","wage2","hours2","leisure2","dpi","gross","choice"])
pdresults= pd.DataFrame(results2020)
pdresults.to_csv("results2020.csv")
